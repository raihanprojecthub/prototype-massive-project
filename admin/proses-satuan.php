...
<html lang="en">
  ...
  <body class="sb-nav-fixed">
    <?php
      ...
      $total_harga = $harga_paket + $harga_ongkir;
    ...
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-primary">
      <!-- Navbar Brand-->
      <a class="navbar-brand ps-3 fw-bold" href="index.html">LAUNDRY</a>
      <!-- Sidebar Toggle-->
                  ...
                  <div class="d-flex gap-3">
                    ...
                    <div class="w-100">
                      ...
                      <div class="mb-3">
                        ...
                        <input type="number" class="form-control" name="per_pcs" id="per_pcs" placeholder="Masukan Jumlah Per/Pcs" value="<?php echo $row->per_pcs; ?>" required>
                      </div>
                      <div class="mb-3">
